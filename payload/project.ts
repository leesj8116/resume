      ...
      descriptions: [
        { 
          ...
          descriptions: [
            ...
            { content: '패브릭 설정 변경을 통한 전체 노드 커밋시점 TPS 성능 수치 증가 (W: +200TPS, R: +400TPS' },
        ...
        { 
          ...
          descriptions: [
            ...
            { content: '서버 장애 시 자동으로 블록체인 시스템 동작여부를 체크해서 복구해주는 스크립트 적용' },
          ],
        },
      ],
    },
    {
      ...
      descriptions: [
        { content: '하이퍼레저 패브릭 기반 블록체인 시스템 구축', },
        {
          ...
          descriptions: [
            { content: '컨테이너 기반의 블록체인 노드, 체인코드 이미지화 후 재배포' },
          ],
        },
      ],
    },
    {
      ...
      descriptions: [
        { 
          ...
          descriptions: [
            { content: 'go언어 기반 체인코드 내 다건 배치 데이터(일별 최대 90000건 이상) 처리 기능 구현' },
    ...
    },
    {
      ...
      descriptions: [
        ...
        { 
          ...
          descriptions: [
            { content: 'A Performance Simulator for DDS Network' },
          ],
        },
      ],
    },
